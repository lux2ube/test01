...
export function SiteFooter() {
    const { social, support } = siteConfig;
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-sm text-muted-foreground">
                            ...
                            <li><Link href={support.helpCenter} className="hover:text-primary">مركز المساعدة</Link></li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-sm text-muted-foreground">
                            <li><Link href={support.privacyPolicy} className="hover:text-primary">سياسة الخصوصية</Link></li>
                            <li><Link href={support.termsOfService} className="hover:text-primary">شروط الخدمة</Link></li>
                        </ul>
                    </div>
                    <div>
