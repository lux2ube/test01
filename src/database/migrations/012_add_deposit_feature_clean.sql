-- ============================================================
-- DEPOSIT FEATURE MIGRATION (Clean Version)
-- ============================================================
...
-- STEP 2: Drop existing functions to avoid signature conflicts
-- ============================================================
DROP FUNCTION IF EXISTS ledger_add_deposit(UUID, NUMERIC, UUID, JSONB, UUID, TEXT);
DROP FUNCTION IF EXISTS ledger_create_withdrawal(UUID, NUMERIC, UUID, JSONB, UUID, TEXT);
DROP FUNCTION IF EXISTS ledger_create_withdrawal(UUID, NUMERIC, UUID, JSONB);
DROP FUNCTION IF EXISTS ledger_create_withdrawal(UUID, NUMERIC, UUID);
DROP FUNCTION IF EXISTS ledger_create_order(UUID, NUMERIC, UUID, JSONB, UUID, TEXT);
DROP FUNCTION IF EXISTS ledger_create_order(UUID, NUMERIC, UUID, JSONB);
DROP FUNCTION IF EXISTS ledger_create_order(UUID, NUMERIC, UUID);

-- STEP 3: Create ledger_add_deposit stored procedure
-- ============================================================
...
-- STEP 4: Recreate ledger_create_withdrawal with new balance formula
-- ============================================================
...
-- STEP 5: Recreate ledger_create_order with new balance formula
-- ============================================================
...
-- STEP 6: Update auto-account trigger to include total_deposit
-- ============================================================
...
-- ============================================================
COMMENT ON TABLE accounts IS 'Stores running totals for user balances. Available balance = total_earned + total_deposit - total_withdrawn - total_pending_withdrawals - total_orders';

-- ============================================================
-- DONE! The deposit feature is now installed.
-- ============================================================
