-- ============================================================
-- STEP 2: CREATE - Run this AFTER Step 1 cleanup completes
-- ============================================================
-- This creates all the deposit feature functions
-- Run this in Supabase SQL Editor AFTER running Step 1
-- ============================================================

-- Add total_deposit column to accounts table
...
-- Create ledger_add_deposit
CREATE FUNCTION ledger_add_deposit(
    p_user_id UUID,
...
-- Create ledger_create_withdrawal with new balance formula
CREATE FUNCTION ledger_create_withdrawal(
    p_user_id UUID,
    p_amount NUMERIC(12, 2),
    p_reference_id UUID,
    p_metadata JSONB DEFAULT '{}'::jsonb,
...
-- Create ledger_create_order with new balance formula
CREATE FUNCTION ledger_create_order(
    p_user_id UUID,
    p_amount NUMERIC(12, 2),
    p_reference_id UUID,
    p_metadata JSONB DEFAULT '{}'::jsonb,
...
-- Update auto-account trigger to include total_deposit
...
-- Verify installation - should show 3 functions
SELECT
